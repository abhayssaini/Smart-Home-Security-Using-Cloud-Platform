...
client = Cloudant("959488fa-a1c4-4c85-****-ed1ee8360c62-bluemix","****719012c25813207ab56cb5ac36c7b057529f14f42a83ab6a95e9da1e2e4b", url="https://959488fa-a1c4-4c85-8129-ed1ee8360c62-bluemix:3d9d719012c25813207ab56cb5ac36c7b057529f14f42a83ab6a95e9da1e2e4b@959488fa-a1c4-4c85-8129-ed1ee8360c62-bluemix.cloudantnosqldb.appdomain.cloud")
client.connect()
...
while True:
    ...
    for(x,y,w,h) in faces:
        ...
        r = requests.get('https://www.fast2sms.com/dev/bulk?authorization=OMyK5jnSDx9CG40kTNihZ6szEpYRqBPJaQAdr7v1bHg2cmLfoUgiV2jnM75hLRKcC6QAS9ePqOWBJ3dy&sender_id=FSTSMS&message=Some one at door&language=english&route=p&numbers=9*********')
        print(r.status_code)
